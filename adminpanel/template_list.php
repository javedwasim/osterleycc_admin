						...
						<?php while ($r = mysql_fetch_array($emailTemplates)) {  ?>
							<tr class="records-row">
								...
								<td>
									...
									<a class="occ-action-icon <?php  if($r['empl_id']==1 || $r['empl_id']==2 || $r['empl_id']==3 || $r['empl_id']==4) {echo "not-active";} else{ echo "Inactive";} ?>" title="Delete" onclick="return confirm('Are you sure you want to delete this record?');" href="?templateId=<?php echo $r['empl_id'];?>" id="anchor" style="cursor:pointer;" ><i class="fa fa-trash-o"></i></a>
								</td>
							</tr>
						<?php }  ?>
						</tbody>
