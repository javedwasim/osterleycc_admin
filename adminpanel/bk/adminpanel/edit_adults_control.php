					...
					<div class="panel-body">
						<form id="formToggleLine" class="form-horizontal no-margin form-border" name="edit-app-details" method="post" action="update_control.php?id=<?php echo $r['Id'];?>&user_id=<?php echo $r['uid'];?>">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_job_title']; ?>" name="jobtitle" id="jobtitle" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_eventimetel']; ?>" name="eventimetel" id="eventimetel" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Last name :</label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_lname']; ?>" name="emerglname" id="emerglname" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
