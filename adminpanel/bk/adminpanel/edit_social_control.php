...
$cont_query = mysql_query("SELECT * FROM countries WHERE `C_ID` = ".$r[occ_country]);
//echo "SELECT * FROM countries WHERE `C_ID` = ".$r[occ_country];
//exit();
$mycountry = mysql_fetch_array($cont_query);
					...
					<div class="panel-body">
						<form id="formToggleLine" class="form-horizontal no-margin form-border" name="edit-app-details" method="post" action="update_control.php?id=<?php echo $r['Id'];?>&user_id=<?php echo $r['uid'];?>">
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_firstname']; ?>" name="fname" id="fname" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_lastname']; ?>" name="lname" id="lname" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_birthday']; ?>" name="birth" id="birth" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							
							<div class="form-group">
								<label class="col-lg-2 control-label">Current age :</label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_age']; ?>" name="age" id="age" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<select class="form-control" id="gender" name="gender" class="form-control">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_mobnumber']; ?>" name="mobnum" id="mobnum" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							
							<div class="form-group">
								<label class="col-lg-2 control-label">Institute/School name :</label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_schoolname']; ?>" name="instname" id="instname" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							?>
							<div class="form-group migration" id="migration" style = "<?php if(!empty($r['occ_city'])) {echo "display: block;";}else{echo "display: none;";} ?>">
								<label class="col-lg-2 control-label">Date moved to the UK :</label>
								<div class="col-lg-10">
									<div class="row">
										<div class="col-lg-3">
											<select name="moved_day" required id="moved_day" class="form-control">
							...
							<div class="form-group edit-control-heading">
								<label class="col-lg-12 control-label" style = "text-align: left;"><h4>Parent/Guardian Information</h4></label>

							</div><!-- /form-group -->
							
							<div class="form-group">
								<label class="col-lg-2 control-label">Parent/Guardian name :</label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_guardian_name']; ?>" name="guardianname" id="guardianname" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_relationship']; ?>" name="relationship" id="relationship" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_address']; ?>" name="address" id="address" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<select name="county" id="county" class="form-control">
										...
										while($cc = mysql_fetch_array($county)) { ?>
										<option value="<?php echo $cc['counties_name'];?>" <?php if($cc['Id'] == $r['occ_sec2_county']){ echo 'selected'; } ?>><?php   echo $cc['counties_name'];  ?></option>
										<?php } ?>
									</select>
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_postcode']; ?>" name="postalcode" id="postalcode" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_daytimetel']; ?>" name="daytimetel" id="daytimetel" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_emailaddress']; ?>" name="emailaddr" id="emailaddr" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_name']; ?>" name="emergname" id="emergname" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Relationship to child : </label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_relationship']; ?>" name="emergrelation" id="emergrelation" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Address : </label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_address']; ?>" name="emergaddress" id="emergaddress" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">City : </label>
								<div class="col-lg-10">
									<select name="city_emg" id="city_emg" class="form-control">
										<option value="0">Select City:</option>
										<?php $county = mysql_query("select * from `uk_city`");
										while($cc = mysql_fetch_array($county)) { ?>
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">County : </label>
								<div class="col-lg-10">
									<select name="county_emg" id="county_emg" class="form-control">
										<option value="0">Select County:</option>
										<?php $county = mysql_query("select * from `uk_county`");
										while($cc = mysql_fetch_array($county)) { ?>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_postcode']; ?>" name="postalcode_emg" id="postalcode_emg" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Day time tel : </label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_daytel']; ?>" name="emergdaytel" id="emergdaytel" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_eventel']; ?>" name="emergeventel" id="emergeventel" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Email address :</label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_email']; ?>" name="emergemail" id="emergemail" class="form-control">
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<?php if($query1 = mysql_query("SELECT * FROM `payment_recieved` WHERE `uid` = '$userId'")) { ?>
								...
								<table  border="1" align="center" cellpadding="5" cellspacing="0" class="table table-hover table-striped">
								  ...
								  <?php 
									...
									<td>
										<?php if(($fetch['status'] == '1') && isset($_SESSION['UserName']) && ($_SESSION['UserName'] == 'Administrator')){
											echo "<a href=\"edit_payment.php?id=".$fetch['payment_id']."&uid=".$userId."\"><i class=\"fa fa-edit fa-lg\"></a>";
										}
										?>
									</td>
								  </tr>
