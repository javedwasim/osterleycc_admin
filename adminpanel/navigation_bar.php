...
<header class="navbar navbar-fixed-top header-navigation">
    <div class="container">
        <div class="navbar-header">
            ...
            <a href="#" class="navbar-brands"><span class="text-danger"><img height="45px"
        ...
        <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="payin_info.php" class="shortcut-link">
                        <span class="shortcut-icon occ-color">
                        <i class="fa fa-money"></i>
                        </span>
                        <span class="text occ-color">Payments</span>
                    </a>
                </li>

                <?php if ($_SESSION['source_type'] != 3): ?>
                    <li>
                        <a href="user_list.php" class="shortcut-link">

                        <span class="shortcut-icon occ-color">
                        <i class="fa fa-user"></i>

                        </span>
                        <span class="text occ-color">Users</span>
                        </a>
                    ...
                    <li>
                        ...
                        <a href="template_list.php" class="shortcut-link">
                        <span class="shortcut-icon occ-color">
                        <i class="fa fa-envelope"></i>
                        </span>
                            <span class="text occ-color">Email Templates</span>
                        </a>
                    </li>
                <?php endif; ?>
