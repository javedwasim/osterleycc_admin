                                ...
                                <form id="formToggleLine" class="form-horizontal no-margin form-border"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group" style="display:
                                            <?php if (isset($result['empl_src_code'])) {echo "block";}else{echo "none";} ?> ">
...
<script>
    ...
    function DoSubmit(){
        tinyMCE.activeEditor.setContent('<span>Loading Content........</span>', {format : 'raw'});
        document.getElementById("formToggleLine").submit();
    }
