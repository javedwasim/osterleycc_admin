					...
					<div class="panel-body">
						<form id="formToggleLine" class="form-horizontal no-margin form-border" name="edit-app-details" method="post" action="update_control.php?id=<?php echo $r['Id'];?>&user_id=<?php echo $r['uid'];?>">
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_age']; ?>" name="age" id="age" class="form-control" required>
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_mobnumber']; ?>" name="mobnum" id="mobnum" class="form-control" required>
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_schoolname']; ?>" name="instname" id="instname" class="form-control" required>
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group migration" id="migration" style = "<?php if(!empty($r['occ_city'])) {echo "display: block;";}else{echo "display: none;";} ?>">
								...
								<div class="col-lg-10">
									<div class="row">
										<div class="col-lg-3">
											<select name="moved_day" required id="moved_day" class="form-control" required>
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_guardian_name']; ?>" name="guardianname" id="guardianname" class="form-control" required>
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								...
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec2_relationship']; ?>" name="relationship" id="relationship" class="form-control" required>
								</div><!-- /.col -->
							</div><!-- /form-group -->
							...
							<div class="form-group">
								<label class="col-lg-2 control-label">Email address :</label>
								<div class="col-lg-10">
									<input type="text" value="<?php echo $r['occ_sec3_emerg_email']; ?>" name="emergemail" id="emergemail" class="form-control" required>
								</div><!-- /.col -->
							</div><!-- /form-group -->
