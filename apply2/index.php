...
This Application is to be filled by the individual that wishes to enrol at Osterley Cricket Club. As part of our ClubMark and new Administration we will now keep all Club Member Information (for 1 year) in a secure database (started 2013 Season). Payment will be required for the registration at the end of the Application. Please make sure you are over 18 years of Age before completing this Application.

</div>

<div style="line-height:25px; text-align:justify;">

Your information will be stored on our Database and will not be passed onto any third parties with the exception of Law Enforcement Agencies and Cricketing Bodies. All data will be treated as confidential and retained on a secure server (encrypted/password protected).
...
<form action="sporting_info.php" id="adults_info" name="adults_info" method="post" style="width:100%; margin:0 auto;" >
...
<div>
    ...
    <div class="secParttwo">
            ...
            <input type="text" name="fname" id="fname" class="fieldsfor" required value="<?php if(isset($_SESSION['fname'])) { echo $_SESSION['fname']; } ?>" placeholder="Your First Name"  />
         </div>
...
<?php } ?>
              ...
              <select name="birthday_year" id="birthday_year" class="fieldsfor" required>
                ...
                <option value="<?php echo $ye ;?>" <?php if(isset($_SESSION['dyear']) && ($_SESSION['dyear']==$ye)){ echo 'selected'; } ?>><?php echo $ye; ?></option>
    ...
    <div class="secParttwo">
        ...
        <select name="countries" id="countries" class="fieldsfor ukcc changewidth" required onChange="ShowMigrate();">
			...
			<option value="<?php echo $cc['C_ID'];?>" <?php if(isset($_SESSION['countries']) && ($_SESSION['countries'] == $cc['C_ID'])){ echo 'selected'; } ?>><?php   echo $cc['C_NAME'];  ?></option>
	...
	<div class="firstSec migration" style="<?php if(isset($_SESSION['occ_city'])&& ($_SESSION['countries']!=232)){echo "display:block;";}else{echo "display:none;";} ?>">

    <div class="secParttwo">

        

        <label for="countries" class="lableFor">City Of Birth :<span>*</span></label>

        

        <input type="text" name="occ_city"  class="fieldsfor" id="occ_city" value="<?php if(isset($_SESSION['occ_city'])&& ($_SESSION['countries']!=232)){echo $_SESSION['occ_city'];} ?>"  placeholder="City Of Birth" />
    ...
    <div class="firstSec migration" id="migration" style="<?php if(isset($_SESSION['mday'])){echo "display:block;";}else{echo "display:none;";} ?>">
    ...
    <div class="secParttwo">
            ...
            <label for="Date of Birth" class="lableFor">Date moved to the UK : <span>*</span></label>
			 ...
			 <select name="moved_day" id="moved_day" class="fieldsfor">

			<option value="">Day:</option>

			<?php for($i=1; $i<=31; $i++){ ?>

			<option value="<?php echo $i; ?>" <?php if(isset($_SESSION['mday']) && ($_SESSION['mday'] == $i)){ echo 'selected'; } ?>><?php echo $i; ?></option>
			...
			<?php } ?>
              ...
              <select name="moved_month" id="moved_month" class="fieldsfor">

                <option value="">Month:</option>

                <option value="Jan" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Jan')){ echo 'selected'; } ?>>Jan</option>

                <option value="Feb" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Feb')){ echo 'selected'; } ?>>Feb</option>

                <option value="Mar" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Mar')){ echo 'selected'; } ?>>Mar</option>

                <option value="Apr" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Apr')){ echo 'selected'; } ?>>Apr</option>

                <option value="May" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'May')){ echo 'selected'; } ?>>May</option>

                <option value="Jun" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Jun')){ echo 'selected'; } ?>>Jun</option>

                <option value="Jul" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Jul')){ echo 'selected'; } ?>>Jul</option>

                <option value="Aug" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Aug')){ echo 'selected'; } ?>>Aug</option>

                <option value="Sep" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Sep')){ echo 'selected'; } ?>>Sep</option>

                <option value="Oct" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Oct')){ echo 'selected'; } ?>>Oct</option>

                <option value="Nov" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Nov')){ echo 'selected'; } ?>>Nov</option>

                <option value="Dec" <?php if(isset($_SESSION['mmonth']) && ($_SESSION['mmonth'] == 'Dec')){ echo 'selected'; } ?>>Dec</option>

              </select>

              <select name="moved_year" id="moved_year" class="fieldsfor">

                <option value="">Year:</option>

				<?php for($ye = 1930; $ye <= 2013; $ye++){ ?>

                <option value="<?php echo $ye ;?>" <?php if(isset($_SESSION['myear']) && ($_SESSION['myear']==$ye)){ echo 'selected'; } ?>><?php echo $ye; ?></option>
    ...
    <div class="secParttwo">
            ...
            <select name="gender" required id="gender"  class="fieldsfor" style="background:#f9f9f9;" required>
...
<?php } ?>
    ...
    <div class="secParttwo">
            ...
            <input type="number" name="etimetel"  id="etimetel" required class="fieldsfor" value="<?php if(isset($_SESSION['etimetel'])) { echo $_SESSION['etimetel']; } ?>" placeholder="Evening telephone number"  />
  ...
  <div class="firstSec">
    ...
    <div class="secParttwo">
            ...
            <input type="email" name="email" id="email" class="fieldsfor" value="<?php if(isset($_SESSION['email'])) { echo $_SESSION['email']; } ?>" placeholder="Your Email address"  />
    ...
    <div>
        ...
        <div ><span id="text" class = "indexheading">Emergency Contact Details</span> <span class = "indexheading">(Section 2 – Emergency Contact Details (Next of Kin)</span></div>
...
In the event of an incident or emergency situation where a parent, next of kin or legal guardian needs to be contacted, please provide details of an adult who can be contacted by the club. Please make this person aware that his or her details have been provided as your next of kin for the club:
    ...
    <div class="secParttwo">
            ...
            <input type="text" name="emerg_name" required id="emerg_name" class="fieldsfor" value="<?php if(isset($_SESSION['emerg_name'])) { echo $_SESSION['emerg_name']; } ?>" placeholder="Contact's First name"  />
    ...
    <div class="secParttwo">
            ...
            <input type="text" name="emerg_lname"  required id="emerg_lname" class="fieldsfor" value="<?php if(isset($_SESSION['emerg_lname'])) { echo $_SESSION['emerg_lname']; } ?>" placeholder="Contact's Last name"  />
    ...
    <div class="secParttwo">
            ...
            <input type="text" name="rel_child_emg" required id="rel_child_emg" class="fieldsfor" value="<?php if(isset($_SESSION['rel_child_emg'])) { echo $_SESSION['rel_child_emg']; } ?>" placeholder="Contact's relationship to your child"  />
    ...
    <div class="secParttwo">
            ...
            <input type="text" name="addr_emg" min = "5" required id="addr_emg" class="fieldsfor" value="<?php if(isset($_SESSION['addr_emg'])) { echo $_SESSION['addr_emg']; } ?>" placeholder="Address line 1"  />
...
<option value="<?php echo $city['Id'];?>" <?php if(isset($_SESSION['cityofuk_emg']) && ($_SESSION['cityofuk_emg'] == $city['cities_name'])){ echo 'selected'; } ?>><?php echo $city['cities_name'];  ?></option>
...
<option value="<?php echo $cc['Id'];?>" <?php if(isset($_SESSION['counties_emg']) && ($_SESSION['counties_emg'] == $cc['counties_name'])){ echo 'selected'; } ?>><?php   echo $cc['counties_name'];  ?></option>
...
<?php } ?>
    ...
    <div class="secParttwo">
            ...
            <input type="number"  name="dtimetel_emg"  required  id="dtimetel_emg" class="fieldsfor" value="<?php if(isset($_SESSION['dtimetel_emg'])) { echo $_SESSION['dtimetel_emg']; } ?>" placeholder="Daytime telephone number"  />
    ...
    <div class="secParttwo">
            ...
            <input type="number"  name="etimetel_emg" required  id="etimetel_emg" class="fieldsfor" value="<?php if(isset($_SESSION['etimetel_emg'])) { echo $_SESSION['etimetel_emg']; } ?>" placeholder="Evening telephone number"  />
    ...
    <div class="secParttwo" align="center">
       ...
       <input type="hidden" value="2" name="source_type" id="source_type">
...
{
	document.getElementById("moved_day").required = true;
	document.getElementById("moved_month").required = true;
	document.getElementById("moved_year").required = true;
