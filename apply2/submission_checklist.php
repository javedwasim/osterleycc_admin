...
<div id="content">
<form action="application_complete.php" name="submission_checklist" id="submission_checklist" method="post">
...
<input type="checkbox" name="circling_ans1" required id="circling_ans1" <?php if(isset($_SESSION['appropriate_ans1'])) echo 'checked';?> value="yes1"  class="appropriate_ans">
...
<div style="border-bottom:1px solid #eee;">
<div class="infoPara" style="position:relative;">
<input type="checkbox" name="circling_ans2" required id="circling_ans2" <?php if(isset($_SESSION['appropriate_ans2'])) echo 'checked';?> value="yes2" class="appropriate_ans">
...
<div style="border-bottom:1px solid #eee;">
<div class="infoPara" style="position:relative;">
<input type="checkbox" name="circling_ans3" required id="circling_ans3" value="yes3" <?php if(isset($_SESSION['appropriate_ans3'])) echo 'checked';?> class="appropriate_ans">
...
<div style="border-bottom:1px solid #eee;">
<div class="infoPara" style="position:relative;">
<input type="checkbox" name="circling_ans4" required id="circling_ans4" value="yes4" <?php if(isset($_SESSION['appropriate_ans4'])) echo 'checked';?>  class="appropriate_ans">
...
<input type="checkbox" name="circling_ans5" required id="circling_ans5" value="yes5" <?php if(isset($_SESSION['appropriate_ans5'])) echo 'checked';?> class="appropriate_ans">
...
<div style="border-bottom:1px solid #eee;">
<div class="infoPara" style="position:relative;">
<input type="checkbox" required name="code_of_conduct" <?php if(isset($_SESSION['code_of_conduct']) && ($_SESSION['code_of_conduct'] == 'yes1')) {echo 'checked';} ?> id="code_of_conduct" value="yes1" required style="position:absolute; top:0; left:0; margin:13px 0 0 10px;">
...
<div class="infoPara" style="position:relative;">
<input type="checkbox" required name="code_of_conduct" <?php if(isset($_SESSION['code_of_conduct']) && ($_SESSION['code_of_conduct'] == 'yes2')) echo 'checked';?> id="code_of_conduct" value="yes2" style="position:absolute; top:0; left:0; margin:13px 0 0 10px;">
...
<a href="information.php" class="backbutton">Back</a>
</div>
</div>
</div>
</div>
