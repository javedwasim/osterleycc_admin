...
<div class="edit-user">
<div class="edit-heads-control floatLeft"> Current age : </div>
<div class="edit-details-control floatLeft"><input type="text" value="<?php echo $r['occ_age']; ?>" name="age" id="age" class="pro-fields"></div>
<div class="clear"></div>
</div>
<div class="edit-user">
...
<div class="edit-user">
<div class="edit-heads-control floatLeft"> Mobile no. : </div>
<div class="edit-details-control floatLeft"><input type="text" value="<?php echo $r['occ_mobnumber']; ?>" name="mobnum" id="mobnum" class="pro-fields"></div>
<div class="clear"></div>
</div>
<div class="edit-user">
<div class="edit-heads-control floatLeft"> Institute/School name : </div>
<div class="edit-details-control floatLeft"><input type="text" value="<?php echo $r['occ_schoolname']; ?>" name="instname" id="instname" class="pro-fields"></div>
<div class="clear"></div>
</div>
<div class="edit-user">
  <div class="edit-heads-control floatLeft">Country of Birth</div>
  <div class="edit-details-control floatLeft">
    <?php echo $mycountry['C_NAME']; ?>
  </div>
  <div class="clear"></div>
</div>
<div class="edit-user">
  <div class="edit-heads-control floatLeft">Date moved to UK</div>
  <div class="edit-details-control floatLeft">
    <?php echo $r['occ_migrated_date']; ?>
  </div>
  <div class="clear"></div>
</div>
...
<div class="edit-user">
<div class="edit-heads-control floatLeft"> Parent/Guardian name : </div>
<div class="edit-details-control floatLeft"><input type="text" value="<?php echo $r['occ_sec2_guardian_name']; ?>" name="guardianname" id="guardianname" class="pro-fields"></div>
<div class="clear"></div>
</div>
<div class="edit-user">
<div class="edit-heads-control floatLeft"> Relationship to child : </div>
<div class="edit-details-control floatLeft"><input type="text" value="<?php echo $r['occ_sec2_relationship']; ?>" name="relationship" id="relationship" class="pro-fields"></div>
<div class="clear"></div>
</div>
<div class="edit-user">
...
<div class="edit-user">
<div class="edit-heads-control floatLeft"> Name : </div>
...
<div class="edit-user">
<div class="edit-heads-control floatLeft"> Email address : </div>
<div class="edit-details-control floatLeft"><input type="text" value="<?php echo $r['occ_sec3_emerg_email']; ?>" name="emergemail" id="emergemail" class="pro-fields"></div>
<div class="clear"></div>
</div>
<div class="banners" style="margin:10px 0;">
