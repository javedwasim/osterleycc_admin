...
if($isPosted > 0){
	if(isset($_POST['chld_ply'])){ $_SESSION['chld_ply'] = $_POST['chld_ply']; }else{unset($_SESSION['chld_ply']);}

	if(isset($_POST['played_cricket1'])){ $_SESSION['played_cricket1'] = $_POST['played_cricket1']; }else{unset($_SESSION['played_cricket1']);}

	if(isset($_POST['played_cricket2'])){ $_SESSION['played_cricket2'] = $_POST['played_cricket2'];}else{unset($_SESSION['played_cricket2']);}

	if(isset($_POST['played_cricket3'])){ $_SESSION['played_cricket3'] = $_POST['played_cricket3'];}else{unset($_SESSION['played_cricket3']);}

	if(isset($_POST['played_cricket4'])){ $_SESSION['played_cricket4'] = $_POST['played_cricket4'];}else{unset($_SESSION['played_cricket4']);}

	if(isset($_POST['played_cricket5'])){ $_SESSION['played_cricket5'] = $_POST['played_cricket5'];}else{unset($_SESSION['played_cricket5']);}

	if(isset($_POST['played_cricket6'])){ $_SESSION['played_cricket6'] = $_POST['played_cricket6'];}else{unset($_SESSION['played_cricket6']);}

	if(isset($_POST['care_impairment'])){ $_SESSION['care_impairment'] = $_POST['care_impairment'];}else{unset($_SESSION['care_impairment']);}

	if(isset($_POST['impairment1'])){ $_SESSION['impairment1'] = $_POST['impairment1'];}else{unset($_SESSION['impairment1']);}

	if(isset($_POST['impairment2'])){ $_SESSION['impairment2'] = $_POST['impairment2'];}else{unset($_SESSION['impairment2']);}

	if(isset($_POST['impairment3'])){ $_SESSION['impairment3'] = $_POST['impairment3'];}else{unset($_SESSION['impairment3']);}

	if(isset($_POST['impairment4'])){ $_SESSION['impairment4'] = $_POST['impairment4'];}else{unset($_SESSION['impairment4']);}

	if(isset($_POST['impairment5'])){ $_SESSION['impairment5'] = $_POST['impairment5'];}else{unset($_SESSION['impairment5']);}

	if(isset($_POST['other_spcf'])){ $_SESSION['other_spcf'] = $_POST['other_spcf'];}else{unset($_SESSION['impairment5']);}

	if(isset($_POST['other_spc'])){ $_SESSION['other_spc'] = $_POST['other_spc'];}else{unset($_SESSION['other_spc']);}

	if(isset($_POST['additional_info'])){ $_SESSION['additional_info'] = $_POST['additional_info'];}else{unset($_SESSION['additional_info']);}

	if(isset($_POST['name_dr'])){ $_SESSION['name_dr'] = $_POST['name_dr'];}else{unset($_SESSION['name_dr']);}

	if(isset($_POST['tel_dr'])){ $_SESSION['tel_dr'] = $_POST['tel_dr'];}else{unset($_SESSION['tel_dr']);}

	if(isset($_POST['medic_info'])){ $_SESSION['medic_info'] = $_POST['medic_info'];}else{unset($_SESSION['medic_info']);}

	if(isset($_POST['medic_consent'])){ $_SESSION['medic_consent'] = $_POST['medic_consent'];}else{unset($_SESSION['medic_consent']);}

	if(isset($_POST['medic_consent_child'])){ $_SESSION['medic_consent_child'] = $_POST['medic_consent_child'];}else{unset($_SESSION['medic_consent_child']);}
}
...
<form name="step3" id="step3" action="step3.php" method="post">

<div class="heading headlines indexheadings2">
...
In order to gain insights and updates on all of Osterley Cricket Clubs Activities and to keep up-to-date with club Fixtures, Events, Policies, Procedures, Regulations and Endorsements please visit the following web profiles:
