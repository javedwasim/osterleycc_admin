...
$username = 'Welcome'. '&nbsp;' .$_SESSION['UserName'];
 ...
 $query1 = "SELECT * FROM occ_registrant as r, payment_recieved as p WHERE r.sid = p.uid and p.status = 1 and p.source_type = 2";
...
<a href="delete_payment.php?pid=<?php echo $r['payment_id'];?>"><img src="images/trash_recyclebin_empty_closed.png" width="20" height="20"></a>
</td>
<?php } ?>
</tr>
</table>
