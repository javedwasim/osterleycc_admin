...
if ($_SESSION['sid']) {
    ...
    $firstname = str_replace('\' ', '\'', ucwords(str_replace('\'', '\' ', strtolower($_SESSION['fname']))));
    $lastname = str_replace('\' ', '\'', ucwords(str_replace('\'', '\' ', strtolower($_SESSION['lname']))));
    ...
    <div id="wrapper">
        ...
        <div id="content">
            <form action="https://www.paypal.com/cgi-bin/webscr" method="post" id="form1">
                ...
                <input type="hidden" name="notify_url" value="http://www.osterleycc.com/apply2/ipn2.php">
              ...
              table-layout: fixed;">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $emergencyContactChild; ?> </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-primary" href="submission-checklist.php"
